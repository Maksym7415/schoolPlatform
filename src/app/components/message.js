...
import {
  Snackbar, IconButton, Icon, SnackbarContent,
} from '@material-ui/core';
import { green, amber, blue } from '@material-ui/core/colors';
import { useDispatch, useSelector } from 'react-redux';
import clsx from 'clsx';
import { makeStyles } from '@material-ui/styles';
import * as Actions from '../redux/theme/constants/actionConstants';
...
function Message(props) {
  ...
  const state = useSelector(({ themeReducer }) => themeReducer.messageState);
  const options = useSelector(({ themeReducer }) => themeReducer.messageOptions);
